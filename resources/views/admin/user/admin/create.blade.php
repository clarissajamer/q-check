...
<div class="max-w-2xl mx-auto bg-white p-8 rounded-xl shadow-sm border border-gray-100">
    <div class="flex items-center justify-between mb-6">
        <h2 class="text-xl font-bold text-gray-800">Tambah Admin Baru</h2>
        <a href="{{ route('admin.users.index', 'admin') }}" class="text-gray-500 hover:text-gray-700">Kembali</a>
    </div>
    ...
    <form action="{{ route('admin.users.store') }}" method="POST">
        ...
        <div class="mb-4">
            ...
            <input type="text" name="name" value="{{ old('name') }}" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:border-blue-500 @error('name') border-red-500 @enderror" placeholder="Nama Admin">
        ...
        <div class="flex justify-end">
            <button type="submit" class="bg-blue-600 text-white px-6 py-2 rounded-lg hover:bg-blue-700 transition">Simpan Admin</button>
        </div>
    </form>
</div>
@endsection
