...
<div class="space-y-6">
    <div class="flex items-center justify-between">
        ...
        <a href="{{ route('admin.users.create', 'admin') }}" class="px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition">
            Tambahkan Admin
        </a>
    </div>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
        <table class="w-full text-left border-collapse">
            ...
            <tbody class="text-gray-600 text-sm font-light">
                ...
                @empty
                <tr>
                    <td colspan="3" class="py-3 px-6 text-center text-gray-500">Belum ada data admin.</td>
                </tr>
                @endforelse
            </tbody>
        </table>
