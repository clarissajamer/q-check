...
<div class="space-y-6">
    <div class="flex items-center justify-between">
        ...
        <a href="{{ route('admin.users.create', 'siswa') }}" class="px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition">
            Tambahkan Siswa
        </a>
    </div>
        ...
        <table class="w-full text-left border-collapse">
            ...
            <tbody class="text-gray-600 text-sm font-light">
                ...
                <tr class="border-b border-gray-100 hover:bg-gray-50">
                    <td class="py-3 px-6">{{ $user->siswa->nis ?? '-' }}</td>
                    ...
                    <td class="py-3 px-6 text-center">
                        <div class="flex item-center justify-center space-x-2">
                            ...
                            <form action="{{ route('admin.users.destroy', $user->id) }}" method="POST" onsubmit="return confirm('Apakah Anda yakin ingin menghapus siswa ini?');" class="inline">
                                @csrf
                                @method('DELETE')
                ...
                @empty
                <tr>
                    <td colspan="3" class="py-3 px-6 text-center text-gray-500">Belum ada data siswa.</td>
                </tr>
                @endforelse
            </tbody>
        </table>
